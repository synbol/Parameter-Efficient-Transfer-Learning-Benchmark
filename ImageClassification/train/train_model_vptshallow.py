...
from models import vision_transformer_vptshallow
    ...
    for ep in tqdm(range(epoch)):
        ...
        if ep % 10 == 9 and ep > 80:
            ...
            if acc > config['best_acc']:
                config['best_acc'] = acc
                print(acc)
                save_path = '/home/ma-user/work/haozhe/synbol/SCT/output/models_save/' + 'vptshallow_' + task + '.pth'
...
if __name__ == '__main__':
    ...
    if 'swin' in args.model:
        ...
        model = create_model(args.model, checkpoint_path=args.model_checkpoint, drop_path_rate=args.dpr, tuning_mode=args.tuning_mode, prompt_len=topN)
