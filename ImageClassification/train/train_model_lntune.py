...
from models import vision_transformer_lntune
    ...
    for ep in tqdm(range(epoch)):
        ...
        if ep % 10 == 9 and ep > 80:
            ...
            if acc > config['best_acc']:
                config['best_acc'] = acc
                print(acc)
                save_path = '/home/ma-user/work/haozhe/synbol/SCT/output/models_save/' + 'lntune_' + dataset + '.pth'
...
if __name__ == '__main__':
    ...
    model = train(config, model, criterion, train_dl, opt, scheduler, logger, config['epochs'], args.task, args.dataset)
