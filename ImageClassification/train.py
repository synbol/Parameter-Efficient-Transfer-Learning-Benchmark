...
parser.add_argument('--lora-rank', type=int, default=4,
                    help='set the tuning mode: LoRA rank')
parser.add_argument('--lora-alpha', type=int, default=4,
                    help='set the tuning mode: LoRA rank')

parser.add_argument('--adapt-bottleneck', type=int, default=4,
                    help='set the bottleneck of AdaptFormer')

parser.add_argument('--vpt-num', default=1, type=int, help='number of VPT prompts')
...
def main():
    ...
    tuning_config =EasyDict(
        ...
        adapt_bottleneck=args.adapt_bottleneck,
